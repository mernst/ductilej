...
/**
 * Implements binary operations with for lhs of Short and rhs of Byte.
 */
public class ShortByteOps implements Ops
{
    public Object plus (Object lhs, Object rhs) {
        return ((Short)lhs).shortValue() + ((Byte)rhs).byteValue();
    }
