...
/**
 * Implements binary operations with for lhs of Integer and rhs of Float.
 */
public class IntegerFloatOps implements Ops
{
    public Object plus (Object lhs, Object rhs) {
        return ((Integer)lhs).intValue() + ((Float)rhs).floatValue();
    }
