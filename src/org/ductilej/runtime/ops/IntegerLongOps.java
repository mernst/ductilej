...
/**
 * Implements binary operations with for lhs of Integer and rhs of Long.
 */
public class IntegerLongOps implements Ops
{
    public Object plus (Object lhs, Object rhs) {
        return ((Integer)lhs).intValue() + ((Long)rhs).longValue();
    }
