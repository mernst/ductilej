...
/**
 * Implements binary operations with for lhs of Short and rhs of Short.
 */
public class ShortShortOps implements Ops
{
    public Object plus (Object lhs, Object rhs) {
        return ((Short)lhs).shortValue() + ((Short)rhs).shortValue();
    }
